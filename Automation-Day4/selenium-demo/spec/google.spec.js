...
describe('The Google.', function () {
    ...
    xit('should have a form', function(done) {
        var form = this.driver.findElement(selenium.By.css('#tsf'));
    ...
    xit('should submit a search term and change its url', function(done) {
    ...
    it('should submit a search term and get a result back', function(done) {
        ...
        this.driver.wait(selenium.until.elementLocated(selenium.By.id('rso')), 1000, 'Could not locate the child element within the time specified');
